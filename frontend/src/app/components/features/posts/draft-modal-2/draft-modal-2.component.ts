...
@Component({
  ...
  templateUrl: './draft-modal-2.component.html',
  styleUrls: ['./draft-modal-2.component.scss']
})
export class DraftModal2Component implements OnInit, OnDestroy {
  drafts: DraftPost[] = [];
  ...
  constructor(
    private dialogRef: MatDialogRef<DraftModal2Component>,
